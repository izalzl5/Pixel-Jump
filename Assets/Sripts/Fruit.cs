...
public class Fruit : MonoBehaviour
{
   ...
   private Animator anim;
    ...
    private void SetRandomLookIfNeeded()
    {
        ...
        int randomIndex = Random.Range(0, 8); //max value is excluded so it will get the number between 0 to 7.
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (player != null)
        {
            ...
            GameObject newFx = Instantiate(pickupVfx,transform.position,Quaternion.identity); //the vfx is in the same position a the fruit.
        }
    }
}
